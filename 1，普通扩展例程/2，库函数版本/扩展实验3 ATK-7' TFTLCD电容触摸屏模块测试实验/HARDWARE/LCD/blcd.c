...
{ 	
  ...
  readWriteTiming.FSMC_AddressSetupTime = 0X6;	 //地址建立时间(ADDSET)为6个HCLK 1/168M=6ns*6=36ns	
  readWriteTiming.FSMC_AddressHoldTime = 0x00;	 //地址保持时间（ADDHLD）模式A未用到	
  readWriteTiming.FSMC_DataSetupTime = 5;			//数据保存时间为6个HCLK	=6*6=36ns
  ...
  readWriteTiming.FSMC_AccessMode = FSMC_AccessMode_A;	 //模式A 
	...
	writeTiming.FSMC_AddressSetupTime =6;	      //地址建立时间（ADDSET）为6个HCLK =36ns 
  writeTiming.FSMC_AddressHoldTime = 0x00;	 //地址保持时间（A		
  writeTiming.FSMC_DataSetupTime = 5;		 //数据保存时间为6ns*6个HCLK=36ns
